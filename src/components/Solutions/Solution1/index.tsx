...
const content = {
  tr: {
    title: 'Çözüm 1',
    description: 'Birinci çözüm açıklaması',
    footerLang: 'tr',
    headerLang: 'tr',
  },
  en: {
    title: 'Solution 1',
    description: 'First solution description',
    footerLang: 'en',
    headerLang: 'en',
  },
};
...
const WebApplications: React.FC = () => {
  ...
  const handleTabChange = (key: string) => {
    ...
    let base = `/${lang}/solutions/solution1`;
  ...
  const breadcrumb = (
    <div className="mt-1 mb-2 text-sm flex items-center space-x-2">
      ...
      <span className="text-gray-400 font-bold">/</span>
      <Link to={`/${lang}/solutions/solution1`} className="text-gray-400 font-bold">{lang === 'tr' ? 'Çözüm 1' : 'Solution 1'}</Link>
