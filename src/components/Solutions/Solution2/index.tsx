...
const content = {
  tr: {
    title: 'Çözüm 2',
    description: 'İkinci çözüm açıklaması',
    footerLang: 'tr',
    headerLang: 'tr',
  },
  en: {
    title: 'Solution 2',
    description: 'Second solution description',
    footerLang: 'en',
    headerLang: 'en',
  },
};
...
const WebApplications: React.FC = () => {
  ...
  const handleTabChange = (key: string) => {
    ...
    let base = `/${lang}/solutions/solution2`;
  ...
  const breadcrumb = (
    <div className="mt-1 mb-2 text-sm flex items-center space-x-2">
      ...
      <span className="text-gray-400 font-bold">/</span>
      <Link to={`/${lang}/solutions/solution2`} className="text-gray-400 font-bold">{lang === 'tr' ? 'Çözüm 2' : 'Solution 2'}</Link>
      ...
      {selectedTab === 'overview' && (
        <>
          <HeroImageTextSection
            ...
            paragraphs={[
              lang === 'tr'
                ? 'İkinci çözüm açıklaması.'
                : 'Second solution description.'
            ]}
          />
