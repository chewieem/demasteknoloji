...
const content = {
  tr: {
    title: 'Çözüm 4',
    description: 'Dördüncü çözüm açıklaması',
    footerLang: 'tr',
    headerLang: 'tr',
  },
  en: {
    title: 'Solution 4',
    description: 'Fourth solution description',
    footerLang: 'en',
    headerLang: 'en',
  },
};
...
const WebApplications: React.FC = () => {
  ...
  const handleTabChange = (key: string) => {
    ...
    let base = `/${lang}/solutions/solution4`;
  ...
  const breadcrumb = (
    <div className="mt-1 mb-2 text-sm flex items-center space-x-2">
      ...
      <span className="text-gray-400 font-bold">/</span>
      <Link to={`/${lang}/solutions/solution4`} className="text-gray-400 font-bold">{lang === 'tr' ? 'Çözüm 4' : 'Solution 4'}</Link>
