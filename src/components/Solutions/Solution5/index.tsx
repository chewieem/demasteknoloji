...
const content = {
  tr: {
    title: 'Çözüm 5',
    description: 'Beşinci çözüm açıklaması',
    footerLang: 'tr',
    headerLang: 'tr',
  },
  en: {
    title: 'Solution 5',
    description: 'Fifth solution description',
    footerLang: 'en',
    headerLang: 'en',
  },
};
...
const WebApplications: React.FC = () => {
  ...
  const handleTabChange = (key: string) => {
    ...
    let base = `/${lang}/solutions/solution5`;
  ...
  const breadcrumb = (
    <div className="mt-1 mb-2 text-sm flex items-center space-x-2">
      ...
      <span className="text-gray-400 font-bold">/</span>
      <Link to={`/${lang}/solutions/solution5`} className="text-gray-400 font-bold">{lang === 'tr' ? 'Çözüm 5' : 'Solution 5'}</Link>
      ...
      {selectedTab === 'overview' && (
        <>
          <HeroImageTextSection
            ...
            paragraphs={[
              lang === 'tr'
                ? 'Beşinci çözüm açıklaması.'
                : 'Fifth solution description.'
            ]}
          />
