...
const content = {
  tr: {
    title: 'Hizmet 3',
    description: 'Üçüncü hizmet açıklaması',
    footerLang: 'tr',
    headerLang: 'tr',
  },
  en: {
...
const WebApplications: React.FC = () => {
  ...
  const handleTabChange = (key: string) => {
    ...
    let base = `/${lang}/services/service3`;
  ...
  const breadcrumb = (
    <div className="mt-1 mb-2 text-sm flex items-center space-x-2">
      ...
      <span className="text-gray-400 font-bold">/</span>
      <Link to={`/${lang}/services/service3`} className="text-gray-400 font-bold">{lang === 'tr' ? 'Hizmet 3' : 'Service 3'}</Link>
