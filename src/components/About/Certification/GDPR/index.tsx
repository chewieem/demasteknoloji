    ...
    <div>
      ...
      <div className="bg-gray-900 py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-sm flex items-center space-x-2 mb-4">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-white">{lang === 'tr' ? 'GDPR' : 'GDPR'}</span>
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">{lang === 'tr' ? 'GDPR' : 'GDPR'}</h1>
      ...
      <div className="bg-white min-h-[40vh] py-16 flex items-center justify-center">
        <div className="max-w-2xl w-full mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{lang === 'tr' ? 'GDPR' : 'GDPR'}</h2>
          <p className="text-gray-700 text-lg whitespace-pre-line">
            {lang === 'tr'
              ? 'Bu bir örnek GDPR metnidir. Kişisel verileriniz Avrupa Birliği Genel Veri Koruma Tüzüğü\'ne (GDPR) uygun olarak işlenir.'
              : 'This is a sample GDPR Policy text. Your personal data is processed in accordance with the European Union General Data Protection Regulation (GDPR).'}
          </p>
        </div>
      </div>
